import javax.swing.*; //to create various applications
...
import java.awt.*;  // used for creating api components like button checkbox, label

import java.awt.event.*;// for img

class Myclass {
    Myclass() {    //Constructor:  It is a special type of method that is used to initialize the object
        // image imported
        ...
        jf.setLocationRelativeTo(null); // centered to null
        jf.setVisible(true);
        ...
        class MyListener implements ActionListener {    // An ActionListener in Java is an interface that is used to handle events triggered by user actions, such as clicking a button or selecting an item from a dropdown menu.
            int flag = 0;
